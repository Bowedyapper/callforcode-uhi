...
const AddResource = function ({ navigation }) {
  const clearItem = { userID: userID(), type: 'Information', name: '', description: '', location: '', contact: '', quantity: '1' }
  ...
  return (
    <ScrollView style={styles.outerView}>
      ...
      <TextInput
        ...
        returnKeyType='send'
        enablesReturnKeyAutomatically={true}
        placeholder='e.g., Water, First Aid, Muster point'
        blurOnSubmit={false}
      />
      ...
      <TextInput
        ...
        returnKeyType='send'
        enablesReturnKeyAutomatically={true}
        placeholder='Other useful description'
      />
