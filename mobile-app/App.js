...
const tabBarOptions = {
  // showLabel: false,
  activeTintColor: '#fe4410',
  inactiveTintColor: '#a0a0a3',
  style: {
...
const DonateStackLayout = () => (
  <Stack.Navigator>
  <Stack.Screen name='My Offers' component={MyResources} options={DonationsStackOptions} />
    <Stack.Screen name='Add Offer' component={AddResource} />
